...
export default function ChatRightBar() {
    ...
    return (
        <div className="h-screen fixed">
            <div className="flex">
                <div className="lg:flex  bg-[#277868] w-[100%] flex-col h-screen pb-2 border-[#fbfbfa] shadow-2xl">
                    ...
                    <div className="message flex flex-col items-center justify-center mt-5">
                        <img
                            ...
                            alt=""
                        />
                        <div className="text-[23px] font-inter text-[#fbfbfa] mt-2">
                            {currComm?.orgName}
                        </div>
                        <div className="text-[15px] font-inter text-[#fbfbfa]">
                            {currComm?.userCount} members
                        </div>
                    </div>
                    <div className="description mt-4 p-3">
                        <div className="desc1 font-inter text-[#fbfbfa] text-[20px]">
                            Description
                        </div>
                        <div className="desc2 font-inter text-[#e2e2e1] text-[10px] w-fit">
                    ...
                    <div className="mt-3">
                        <div className=" flex items-center">
                            <img
                                ...
                                alt=""
                            />
                            <div className="member text-[20px] font-inter text-[#fbfbfa]">
                                Members
                            </div>
                        </div>
                            ...
                            {currComm?.joinedUsers?.map((member) => (
                                <a href="">
                                    <div className=" flex items-center mx-1 mt-1">
                                        <img
                                            className="w-[25px] h-[25px] 2xl:w-[50px] 2xl:h-[50px]  rounded-full hover:scale-105 duration-300  "
                                            src={
                                                member.avatar
                                                    ? member.avatar
                                                    : person
                                        ...
                                        <div className="member ml-2  text-[15px] font-inter text-[#fbfbfa]">
                                            {member.name}
                                        </div>
                                    </div>
                                </a>
