...
export default function JoinUs() {
    ...
    return (
        <div name="support" className="w-full mt-10">
            <div className="w-full h-[800px] absolute mx-auto overflow-y-scroll bg-cover bg-fixed bg-center bg-no-repeat bg-[url('./assets/images/joinUs.png')]">
            ...
            <div className="max-w-[1240px] mx-auto relative">
                <div className="px-4 py-12 flex flex-col justify-center items-center">
                    ...
                    <button
                        ...
                        className=" flex  justify-center items-center git mt-16 py-2 px-6 text-center md:text-3xl mb-10 text-[#dbdbdb]   bg-[#277868] font-bold  hover:shadow-lg hover:scale-110 duration-300 rounded-lg"
                    >
                        <Link
                            to={
                                (!role && user) || role === "user"
