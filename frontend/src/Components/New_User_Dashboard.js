...
import User_Dash2 from "./User_Dash2.js";
import User_dash3 from "./User_dash3.js";
...
import Maps_DashBoard from "./Maps_Dashboard.js";
import { auth, storage } from "../firebase.js";
import { getDownloadURL, ref } from "firebase/storage";
import { useAuthState } from "react-firebase-hooks/auth";
import Card_line from "./Card_line.js";
                ...
                fetch(`${process.env.REACT_APP_DEPLOYED_API_URL}/campaign`)
                    ...
                    .then((campaigns) => {
                        ...
                        campaigns.data.forEach((campaign) => {
                            ...
                            } else if (campaign.endDate < currTime) {
                                past.push(campaign);
                            }
                        });
                        setLoader(false);
