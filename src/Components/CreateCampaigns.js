      ...
      <div className="max-w-[1240px] mx-auto justify-center items-center relative z-2">
        ...
        <div className="grid md:grid-cols-2 px-2 py-12">
          <div className="">
            ...
            <button className="flex mt-8 py-2 px-3 lg:px-6 text-center md:text-2xl  text-white border bg-[#0F1035] hover:font-bold hover:bg-transparent hover:border-[#0F1035] hover:text-[#0F1035] rounded-md">
              Create Now
              <FaArrowRight className="hidden md:flex ml-4 mt-2 " size={20} />
            </button>
          </div>
          <div>
            <img
              src={campaign}
              className="hidden md:block ml-3 md:mt-16 lg:mt-0 w-[40rem]"
              alt="ecobloom"
            />
          </div>
        </div>
