      ...
      <div className="max-w-[95%] mx-auto flex flex-col justify-center items-center">
        ...
        <a href="https://www.instagram.com/eco_bloom_/" target="_blank">
          <button
            data-aos="fade-up"
            data-aos-duration="1500"
            className="flex  justify-center items-center  mt-12 py-2 px-6 text-center md:text-3xl mb-10 text-[#dbdbdb] border bg-[#277868] hover:scale-110 duration-300 font-bold  hover:shadow-lg  rounded-md"
          >
            See More
