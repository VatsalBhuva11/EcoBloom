      ...
      >
        <div className="bg-[#E1E1E0] p-7 rounded w-96 flex flex-col justify-center mt-7 gap-3">
          <form className="space-y-2 md:space-y-4" action="#" id="emailSignUp">
            ...
            <input
              className="block w-full text-sm  file:bg-[#277868] text-[#277868] file:text-[#E9E9E9] file:p-2 file:rounded-lg file:font-bold file:hover:scale-105 file:duration-300 rounded-lg cursor-pointer focus:outline-none bg-transparent "
