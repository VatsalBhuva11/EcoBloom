        ...
        <div className="h-screen bg-[#EEF0E5] flex justify-around items-center">
            <div className="flex flex-col justify-around items-center sm:items-start h-[30%] xl:h-[40%] ml-5 ">
                ...
                <div className="flex flex-col items-center sm:items-start gap-2">
                    <input
                        type="email"
                        className="bg-[#CCD994] text-[#685E5E] placeholder:text-[#464444] placeholder:xl:text-lg placeholder:lg:text-md placeholder:text-sm h-8 md:h-9 lg:h-10  sm:w-52 md:w-60 lg:w-72 xl:w-96 rounded-xl p-3 w-80"
                        placeholder="📧 Enter Your E-mail"
                    />
                    <button className="sm:h-8 md:h-9 lg:h-10  sm:w-52 md:w-60 lg:w-72 xl:w-96 bg-[#CB4331] text-[#eef0e5] rounded-xl sm:text-sm lg:text-md xl:text-lg w-80 h-8">
                        SEND RESET LINK
                    </button>
