  ...
  function googleSignIn() {
    ...
    signInWithPopup(auth, googleProvider)
      .then((result) => {
        ...
        auth.currentUser.getIdTokenResult().then(async (tokenResult) => {
          setGoogleClicked(true);
          // const res = await fetch(`${process.env.REACT_APP_DEPLOYED_API_URL}/auth/user/register`);
          const profileDets = getAdditionalUserInfo(result).profile;
          ...
          if (responseData.error !== "user already exists") {
            ...
            setCustomClaims({
              ...
              .catch((err) => {
                ...
                console.log("error from setting custom claims:", err);
                setGoogleClicked(false);
      ...
      .catch((error) => {
        ...
        if (
          ...
          setStatus("failure");
          setMessage("Error occurred while signing you in with google.");
          console.log(error);
    ...
    <div className=' absolute -z-10 bg-[url("./assets/images/authBg.jpg")]  h-full w-screen r'>
      <div className=" flex justify-center items-center">
        <div className="flex flex-col  px-6 py-8 w-[50rem]  items-center justify-center md:h-screen lg:py-0 ">
          <div className="w-full rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0 bg-[#f5fbf5] ">
