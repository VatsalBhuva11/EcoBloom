...
const Maps_Card = ({ visible, onClose, formData, setFormData }) => {
    ...
    return (
        <div
            ...
            className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex items-center justify-center h-[80%]"
        >
            <div className="bg-[#CDE1C9] p-6 rounded flex flex-col items-center justify-center">
