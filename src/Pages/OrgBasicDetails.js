                        ...
                        if (data.status === "error") {
                            ...
                            setCustomClaims(userData)
                                ...
                                .catch((err) => {
                                    ...
                                    setSignUpClicked(false);
                                    setStatus(
                                        "Failure while setting custom claims"
                                    );
                                });
                                ...
                                {!signUpClicked ? (
                                    ...
                                    >
                                        <div role="status">
                                            <svg
                                                aria-hidden="true"
                                                class="flex justify-center items-center w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
                                                viewBox="0 0 100 101"
                                                fill="none"
