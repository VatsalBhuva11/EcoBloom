                    ...
                    <div className="mt-8 md:mt-12 mr-8 ml-8 pb-4 rounded-lg backdrop-filter text-[#686968] backdrop-blur-lg z-30 bg-opacity-30 bg-[#bebaba] border-t border-b border-[#8c858544] shadow-md ">
                        <div className="ml-5 md:ml-10 w-fit  bg-transparent flex-col   items-center  ">
                            ...
                            <p className="md:text-xl text-md lg:text-2xl mt-4 lg:mt-6 ">
                                The Guidelines Review Committee ensure that WHO
                                guidelines are of a high methodological quality
                                and are developed through a transparent,
                                evidence.Guidelines are subject to a rigorous
                                quality assurance process that helps to ensure
                                that each and every published guideline is
                                trustworthy, impactful and meets the highest
