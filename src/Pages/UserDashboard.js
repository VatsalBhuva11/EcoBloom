...
>>>>>>> aa34d2cce00faffdb512226631b7c887a943a455
        ...
        <div className="h-screen">
            <div className="w-full h-[14%] bg-[#0f1035] text-white flex justify-between ">
                ...
                <div
                    className={
                        !nav1
                            ? " flex flex-col cursor-pointer text-white text-2xl absolute right-10 top-[7.25rem] sm:w-[25%] border-r border-r-gray-900 bg-[#0f1035] ease-up-down duration-0"
            ...
            <div className="flex">
                <div className="hidden xl:flex h-[797px] bg-[#0f1035] w-[25%] flex-col items-center pb-2 border-t border-[#eef0e5]">
                    <button className=" flex justify-center items-center gap-1 bg-[#eef0e5] text-[#0f1035] xl:text-[17px] 2xl:text-[22px] font-bold rounded-xl h-[2.8rem]  2xl:h-[3.20rem] w-56 2xl:w-64 my-4 2xl:my-6 hover:scale-105 duration-300">
                        {" "}
                        <FaPlus /> Join Community
                    </button>
                    <p className="text-[#eef0e5] text-2xl 2xl:text-3xl font-bold mb-8">
                        Joined Communities
                    </p>
                    <div className="flex flex-col gap-4 2xl:gap-5">
                        <a href="">
                            <div className="flex pb-5 2xl:pb-3 border-b-2 xl:gap-3 2xl:gap-7 px-4 2xl:px-7 hover:scale-105 duration-300">
                                <img
                                    className="w-[50px] h-[50px] 2xl:w-[60px] 2xl:h-[60px] rounded-full"
                                    src={person}
                                    alt=""
                                />
                                <div className="flex flex-col">
                                    <p className="text-[#eef0e5] text-[0.88rem] 2xl:text-xl mt-1 2xl:mt-0">
                ...
                <div className="w-full 2xl:w-[75%] lg:h-[797px] bg-[#eef0e5] flex flex-col lg:flex-row lg:justify-center items-center justify-center gap-20">
                    ...
                    <div className="flex flex-col items-center gap-8 mr-6 ">
                        ...
                        <button className=" flex justify-center items-center gap-1 bg-[#eef0e5] text-[#0f1035] xl:text-[17px] 2xl:text-[22px] font-bold rounded-xl h-[2.8rem] border-4 border-[#0f1035] 2xl:h-[3.20rem] w-56 2xl:w-64 my-4 2xl:my-5 hover:scale-105 duration-300">
                            View More{" "}
                            <div className="mt-[0.32rem] text-3xl">
                                <FaLongArrowAltRight />
                            </div>{" "}
            ...
            <div
                className={
                    nav
                        ? "absolute left-0 top-[7.75rem] flex flex-col   border-r border-r-gray-900 ease-in-out duration-500 h-[797px] bg-[#0f1035]"
                        : "ease-in-out duration-500 fixed left-[-200%]"
                }
            >
...
>>>>>>> aa34d2cce00faffdb512226631b7c887a943a455
        ...
        <div className={!nav1 ? ' flex flex-col cursor-pointer text-white text-2xl absolute right-10 top-[5.25rem] sm:w-[25%] border-r border-r-gray-900 bg-[#0f1035] ease-up-down duration-0' : 'ease-up-down duration-0 fixed left-[-200%]'}>
      ...
      <div className='flex h-full'>
        <div className='hidden xl:flex bg-[#0f1035] w-[25%] flex-col justify-around gap-0 items-center pb-0 border-t border-[#eef0e5]'>
          <button className=' flex justify-center items-center gap-1 bg-[#eef0e5] text-[#0f1035] xl:text-[15px] 2xl:text-[19px] font-bold rounded-xl h-[2.8rem]  2xl:h-[3.2rem] w-56 2xl:w-64 hover:scale-105 duration-300 mt-3'> <FaPlus/> Join Community</button>
          <p className='text-[#eef0e5] text-2xl 2xl:text-2xl font-bold my-1 mt-1'>Joined Communities</p>
          <div className='flex flex-col gap-2 2xl:gap-5' >
            <a href="">
              ...
              <img className='w-[50px] h-[50px] 2xl:w-[52px] 2xl:h-[52px] rounded-full' src={person} alt="" />
              <div className='flex flex-col'><p className='text-[#eef0e5] text-[0.88rem] 2xl:text-[1rem] mt-1 2xl:mt-0'>GreenPeace Organisation</p>
              <p className='text-[#eef0e5] text-[0.75rem] 2xl:text-[0.9rem]'>345 Peoples</p></div>
              </div>
            </a>
            <a href="">
              <div className='flex pb-3 2xl:pb-3 border-b-2 xl:gap-3 2xl:gap-4 px-4 2xl:px-7 hover:scale-105 duration-300'>
        ...
        <div className='w-full 2xl:w-[75%] bg-[#eef0e5] flex flex-col lg:flex-row lg:justify-around  
         justify-center items-center gap-10'>
          ...
          <div className='flex flex-col items-center gap-5 mr-6 py-8 xl:py-6'>
            ...
            <button className=' flex justify-center items-center gap-1 bg-[#eef0e5] text-[#0f1035] xl:text-[17px] 2xl:text-[22px] font-bold rounded-xl h-[2.8rem] border-4 border-[#0f1035] 2xl:h-[3.20rem] w-56 2xl:w-64 2xl:my-5 hover:scale-105 duration-300'>View More <div className='mt-[0.32rem] text-3xl'><FaLongArrowAltRight/></div> </button>
          </div>
          
        </div>
      </div>
      <div className={nav ? 'absolute left-0 top-[5.25rem] flex flex-col h-[600px] border-r border-r-gray-900 ease-in-out duration-500 bg-[#0f1035]' : 'fixed left-[-200%]'}>
      <div className='flex bg-[#0f1035] w-[300px] flex-col items-center pb-2 border-t border-[#eef0e5] p-4'>
          <button className=' flex justify-center items-center gap-1 bg-[#eef0e5] text-[#0f1035] xl:text-[17px] 2xl:text-[22px] font-bold rounded-xl h-[2.8rem]  2xl:h-[3.20rem] w-56 2xl:w-64 hover:scale-105 duration-300 my-2'> <FaPlus/> Join Community</button>
          <p className='text-[#eef0e5] text-2xl 2xl:text-3xl font-bold my-3'>Joined Communities</p>
          <div className='flex flex-col gap-3 2xl:gap-5' >
            <a href="">
              <div className='flex pb-3 border-b-2 xl:gap-3 2xl:gap-7 px-4 2xl:px-7 hover:scale-105 duration-300'>
