                ...
                <a href="" class="text-gray-500 hover:text-gray-900 hover:bg-gray-100 rounded transition duration-150 ease-in font-medium text-sm text-center w-full py-3">Email</a>
                    ...
                    <div class="w-full">
                        ...
                        <div class="mt-5 w-full flex flex-col items-center overflow-hidden text-sm">
                            ...
                            <a  class="w-full border-t border-gray-100 text-gray-600 py-4 pl-6 pr-3 block hover:bg-gray-100 transition duration-150" ><button onClick={handleLinkWithGoogle}>
                            ...
                            <div class="flex items-center justify-center bg-white w-9 h-9 r rounded-full mr-3">
                                    ...
                                    <div className="title">Link with Google</div>
                            </div>
                           </button>
                            {googleLinked === null ? (
                                <div></div>
                            ) : googleLinked === true ? (
                                <div className="text-green-500 ml-5">Successfully logged in</div>
                            ) : (
                                <div className=" text-red-500 ml-5">Failure while logging in</div>
                            )}
                            </a>
