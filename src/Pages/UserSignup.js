                ...
                >
                          ...
                          {isOpen && (
                            ...
                            >
                              <div className=" text-[10px]">
                                &rarr; upload a clear picture of your face with
                                size less than 2mb
                              </div>
                              <div className="text-[10px]">
                                &rarr; size of the image should be between 48
                                <sup>*</sup>48 pixels and 4096
                                <sup>*</sup>4096 pixels
                              </div>
                              <div className="text-[10px]">
                                &rarr; Format of the image should be either JPG,
                                JPEg or PNG
                              </div>
                              <div className="text-[10px]">
                                &rarr; It would be preferred to upload a clear
                                photo where face is clearly visible
                              </div>
                            </div>
                          )}
                        </div>
                  ...
                  {status === "success" ? (
                    ...
                    <p className="text-md text-red-500">
                      Error occurred while registering user. Please try again.
                    </p>
                  ) : null}
