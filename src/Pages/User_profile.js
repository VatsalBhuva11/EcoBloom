  ...
  return (
    <div className=''>
      <div class="bg-[#eef0e5] relative shadow rounded-lg w-5/6 md:w-5/6  lg:w-4/6 xl:w-3/6 mx-auto mt-32">
        ...
        <div class="mt-16">
            <h1 class="font-bold text-center text-3xl text-gray-900">Rachel Green</h1>
            <p class="text-center text-sm text-gray-400 font-medium">New York</p>
            <p>
                <span>
            ...
            <div className='flex justify-evenly my-5 text-[12px] sm:text-[15px]'>
              <div className='flex flex-col justify-center items-center bg-[#DFE4C5] rounded-lg px-5'>
                <div>35🪙</div><div>Earned</div>
              </div>
              <div className='flex flex-col justify-center items-center bg-[#DFE4C5] rounded-lg px-5'>
                <div>53</div><div className='flex flex-col items-center justify-center gap-0'><div>Campaigns</div><div>Attended</div></div>
              </div>
              <div className='flex flex-col justify-center items-center bg-[#DFE4C5] rounded-lg px-5'>
                <div>21</div><div className='flex flex-col items-center justify-center gap-0'><div>Communities</div><div>Joined</div></div>
              </div>
            </div>
            <div class="w-full">
                {/* <h3 class="font-medium text-gray-900 text-left px-6">Recent activites</h3> */}
                <div class="mt-5 w-full flex flex-col items-center overflow-hidden text-sm">
                    <a onClick={()=>setShowMyModal(true)} href="#" class="w-full border-t border-gray-100 text-gray-600 py-4 pl-6 pr-3 block hover:bg-gray-100 transition duration-150">
                            <img src={logo} alt="" class="rounded-full h-6 shadow-md inline-block mr-2"/>
                                Edit Password
                    </a>
                    <a onClick={()=>setShowMyModal1(true)} href="#" class="w-full border-t border-gray-100 text-gray-600 py-4 pl-6 pr-3 block hover:bg-gray-100 transition duration-150">
                        <img src={logo} alt="" class="rounded-full h-6 shadow-md inline-block mr-2"/>
                            Change Profile Photo
                    </a>

                    <a onClick={()=>setShowMyModal2(true)} href="#" class="w-full border-t border-gray-100 text-gray-600 py-4 pl-6 pr-3 block hover:bg-gray-100 transition duration-150">
                        <img src={logo} alt="" class="rounded-full h-6 shadow-md inline-block mr-2"/>
                        Update Contact Number
                    </a>

                    <a onClick={()=>setShowMyModal3(true)} href="#" class="w-full border-t border-gray-100 text-gray-600 py-4 pl-6 pr-3 block hover:bg-gray-100 transition duration-150">
                        <img src={logo} alt="" class="rounded-full h-6 shadow-md inline-block mr-2"/>
                        Verify email
                    </a>
                    <a href="" className=' text-green-800 font-bold text-xl py-3'>Logout</a>
      ...
      <Update_Contact_Number onClose={handleOnClose2} visible={showMyModel2}/>
